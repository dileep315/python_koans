...
class AboutControlStatements(Koan):
    ...
    def test_for_statement(self):
        ...
        self.assertEqual(["fish".upper(), "and".upper(), "chips".upper()], result)
    ...
    def test_for_statement_with_tuples(self):
        ...
        self.assertRegex(result[2], "Contestant: 'Robin'   Answer: 'Blue! I mean Green!'")

        self.assertNotRegex(result[0], "Contestant: 'Lancelot1'   Answer: 'Blue'")
        self.assertNotRegex(result[1], "Contestant: 'Galahad1'   Answer: 'I don\'t know!'")
        self.assertNotRegex(result[3], "Contestant: 'Arthur1'   Answer: 'Is that an African Swallow or European Swallow?'")
